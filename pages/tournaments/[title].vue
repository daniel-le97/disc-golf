<template>
  <main v-if="tournament" class="min-h-screen px-20">
   <div class="flex p-10 space-x-2">
     <div class="w-1/6">
      <div class=" border-black/30 border-2 text-xl bg-orange-500 text-white font-bold drop-shadow  shadow-inset flex justify-center">
        Tournament
      </div>
        <div class="">
          HOSTED BY: <br>
...
<div class=" flex p-2 pl-0 bg-lime-300/20">
  <!-- LEFT COLUMN -->
<div class="lg:w-3/5 p-2 bg-white border rounded rounded-l-none border-l-0 border-emerald-900/20">
 <div class="flex w-full items-center justify-center">
   <button class="p-2 bg-green-500 px-4 text-white font-bold text-2xl border-emerald-900/30 rounded border-2">REGISTER ONLINE NOW</button>
 </div>
  ...
  <div class="">
    <div class="flex">
      ...
      <div class=" text-sm p-1">
        <p class="text-lg text-emerald-500">{{tournament.location}}</p>
       <div class="flex items-center space-x-1">
         <p>{{ tournament.location }}</p>
          <p class="text-xs text-orange-400">Get Directions</p>
       </div>
      </div>
    </div>
  </div>
...
<hr class="my-3">
<div class="">
  <h3 class="font-bold">Player Divisions & Entry Fees</h3>
 <div class="">
...
<div class=" my-3">
  ...
  <div class="">
    ...
    <div class="flex items-center ">
      ...
      <div class="p-1">
         <h3 class="font-bold">Event Director</h3>
    ...
    <div class="">
      <h3 class="font-bold mb-1">About This Tournament</h3>
