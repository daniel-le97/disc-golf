...
<template>
  <main v-if="tournament" class="min-h-screen px-20">
    ...
    :ui="{wrapper:'space-y-0', list: { width: 'w-full', marker: { background: 'bg-emerald-700' },base:'border-b-4 border-b-emerald-700 rounded-none  rounded-t-md  gap-2',padding:'p-2',tab:{
    ...
    >
      ...
      <template #default="{ item, index, selected }">
        ...
        <template #item="{ item }">
          <UContainer :ui="{padding:'p-0 lg:p-0 md:p-0'}">
            <template #header>
