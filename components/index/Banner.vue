    ...
    <div class="lg:w-1/2 flex items-center justify-center p-5 relative overflow-hidden   ">
      <div class="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center z-10 backdrop-blur-md h-full bg-white/10 rounded-md border-2 border-white/10 flex flex-col items-center justify-center p-4 shadow-xl">
        ...
        <p class="mb-6 text-base text-indigo-100 md:text-lg">
          Sign up today and be part of a thriving community passionate about disc golf. Contribute to the excitement, share your stories, and connect with fellow enthusiasts!
        </p>

        <a
          href="/"
          class="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-emerald-500 hover:bg-emerald-700 focus:shadow-outline focus:outline-none"
        >
          Sign Up
        </a>
